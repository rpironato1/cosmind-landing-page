  ...
  const values = [
    {
      ...
      title: 'IA Mística',
      description:
        'Inteligência artificial avançada que compreende os padrões cósmicos e oferece leituras precisas e personalizadas.',
    },
    {
      icon: Moon,
      title: 'Sabedoria Ancestral',
      description:
        'Combinamos conhecimento astrológico milenar com tecnologia moderna para revelações profundas sobre seu destino.',
    },
    {
      icon: MagicWand,
      title: 'Personalização Única',
      description:
        'Cada horóscopo é criado especificamente para você, considerando sua energia pessoal e momento cósmico atual.',
    },
    {
      icon: CheckCircle,
      title: 'Precisão Cósmica',
      description:
        'Nossa metodologia comprovada oferece insights precisos que guiam suas decisões e revelam oportunidades.',
    },
  ]
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="font-sans text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Somos pioneiros na fusão entre astrologia tradicional e
              inteligência artificial, oferecendo uma experiência única de
              autoconhecimento através do cosmos digital.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
            ...
            >
              ...
              <div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
                <p>
                  No CosMind, acreditamos que os segredos do universo podem ser
                  desvendados através da tecnologia. Nossa plataforma
                  revolucionária combina a sabedoria astrológica ancestral com
                  algoritmos de IA de última geração.
                </p>

                <p>
                  Utilizamos processamento de linguagem natural e análise de
                  padrões cósmicos para criar horóscopo personalizados que vão
                  além das previsões genéricas, oferecendo insights profundos
                  sobre sua jornada pessoal.
                </p>

                <p>
                  Nosso sistema aprende continuamente com os ciclos astrais,
                  posições planetárias e energias cósmicas, garantindo leituras
                  cada vez mais precisas e relevantes para sua vida cotidiana.
                </p>
              </div>
            </motion.div>
