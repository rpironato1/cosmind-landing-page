        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto mb-6">
              Acompanhe os movimentos cósmicos em tempo real e suas influências
              energéticas
            </p>
          ...
          {transitData ? (
                  ...
                  <CardContent className="space-y-4">
                    <div className="text-center">
                      ...
                      <h3 className="font-display text-xl mb-2">
                        {transitData.moonPhase.phase}
                      </h3>
                      <Progress
                        value={transitData.moonPhase.illumination}
                        className="mb-4"
                      />
              ...
              >
                <Card className="h-full glass border-primary/20">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Movimentos planetários influentes
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      {transitData.majorTransits
                              ...
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  <h4 className="font-medium flex items-center gap-2">
                                    ...
                                    <Badge
                                      variant="outline"
                                      className={getInfluenceColor(
                                        transit.influence
                                      )}
                                    >
                                      {getInfluenceIcon(transit.influence)}{' '}
                                      {transit.influence}
                                    </Badge>
                                  </h4>
                                  <p className="text-sm text-muted-foreground">
                      ...
                      {transitData.majorTransits.length > 3 && (
                        ...
                        >
                          {isExpanded
                            ? 'Ver Menos'
                            : `Ver Mais ${transitData.majorTransits.length - 3} Trânsitos`}
                        </Button>
                      )}
                    </div>
                  </CardContent>
              ...
              >
                <Card className="glass border-primary/20">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Tendências cósmicas para os próximos dias
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    ...
                    <div className="mt-4 text-xs text-muted-foreground">
                      Última atualização:{' '}
                      {new Date(transitData.lastUpdated).toLocaleString(
                        'pt-BR'
                      )}
                    </div>
                  </CardContent>
            ...
            >
              ...
              <p className="text-muted-foreground max-w-md mx-auto mb-6">
                Clique em "Atualizar Trânsitos" para revelar os movimentos
                planetários atuais e suas influências cósmicas.
              </p>
            </motion.div>
          )}
            ...
            >
              <div className="glass p-8 rounded-2xl max-w-2xl mx-auto">
                ...
                <p className="text-muted-foreground mb-6">
                  Com base nos trânsitos atuais, explore como otimizar este
                  momento
                </p>
