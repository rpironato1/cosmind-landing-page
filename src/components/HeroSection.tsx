...
export function HeroSection({ onCtaClick, onSectionClick }: HeroSectionProps) {
  return (
    <section
      id="hero"
      className="min-h-screen flex items-center justify-center bg-gradient-cosmic relative overflow-hidden"
    >
      ...
      <div className="container mx-auto px-6 py-32 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <br />
            <span className="text-foreground">Portal Cósmico</span>
          </motion.h1>
          ...
          >
            ...
            Conecte-se ao cosmos e desvende seu destino através de leituras
            místicas premium.
          </motion.p>
